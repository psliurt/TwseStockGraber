...
namespace TwStockGrabBLL.DAL
{
    ...
    public partial class d_dealtr_hedge_daily
    {
        ...
        public Nullable<int> risk_buy_in { get; set; }
        public Nullable<int> risk_sell_out { get; set; }
        public Nullable<int> risk_diff { get; set; }
