...
namespace TwStockGrabBLL.DAL
{
    ...
    public partial class d_stk_wn1430
    {
        ...
        public Nullable<int> deal_stock_count { get; set; }
        public Nullable<decimal> deal_money { get; set; }
        public Nullable<int> deal_trade_count { get; set; }
        ...
        public Nullable<decimal> next_up_limit { get; set; }
        public Nullable<decimal> next_down_limit { get; set; }
