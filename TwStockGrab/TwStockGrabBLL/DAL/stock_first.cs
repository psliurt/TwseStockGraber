...
namespace TwStockGrabBLL.DAL
{
    ...
    public partial class stock_first
    {
        ...
        public Nullable<decimal> last_buy_in_price { get; set; }
        public Nullable<long> last_buy_ask_qty { get; set; }
        public Nullable<decimal> last_sell_out_price { get; set; }
        public Nullable<long> last_sell_ask_qty { get; set; }
        public Nullable<decimal> pe_rate { get; set; }
